...
const youIcon = L.divIcon({
  ...
  html: `<div style="display:flex;flex-direction:column;align-items:center">
           <div style="background:#000;padding:2px 8px;border-radius:6px;font-size:11px;font-weight:900;box-shadow:0 2px 6px rgba(0,0,0,.4);margin-bottom:3px;color:#fff;border:1px solid #fff;letter-spacing:0.5px">YOU</div>
